  ...
  return (
    <AdminShell>
      <header className="page-header">
        ...
        <ButtonLink href="/institutions/new">New institution</ButtonLink>
      </header>
      ...
      <section className="grid grid-2" style={{ marginTop: 24 }}>
        <Card>
          ...
          <div className="grid">
            {institutions.map((institution) => (
              <a className="card card-soft" href={`/institutions/${institution.id}`} key={institution.id}>
        ...
        <Card>
          ...
          <div className="button-row">
            <ButtonLink href="/institutions/new">Create school</ButtonLink>
            <ButtonLink href="/institutions" variant="secondary">
              Search schools
            </ButtonLink>
          </div>
